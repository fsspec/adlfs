...
class AzureBlobFileSystem(AsyncFileSystem):
    ...
    **  Read files as: **
    ...
    def info(self, path, refresh=False, **kwargs):
        ...
        if fetch_from_azure:
            return sync(self._info, self, path, refresh)
    ...
    def glob(self, path, **kwargs):
        return sync(self._glob, self, path)
    ...
    def rmdir(self, path: str, delimiter="/", **kwargs):
        sync(self._rmdir, self, path, delimiter=delimiter, **kwargs)
    ...
    def size(self, path):
        return sync(self._size, self, path)
    ...
    def isfile(self, path):
        return sync(self._isfile, self, path)
    ...
    def isdir(self, path):
        return sync(self._isdir, self, path)
    ...
    def exists(self, path):
        return sync(self._exists, self, path)
    ...
    def url(self, path, expires=3600, **kwargs):
        return sync(self._url, self, path, expires, **kwargs)
    ...
    def expand_path(self, path, recursive=False, maxdepth=None):
        return sync(self._expand_path, self, path, recursive, maxdepth)
